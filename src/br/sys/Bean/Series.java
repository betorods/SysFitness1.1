...
public class Series extends Alunos{
    ...
    public Series(int idSerie, String tipo, String exercicio, String data_inicio, String data_termino, float altura, float peso, float panturrilha, float braco, float perna, float cintura, float coxa, float peitoral, float costas, int Id_Alunos) {
        super(altura, peso, panturrilha, braco, perna, cintura, coxa, peitoral, costas, Id_Alunos);
        this.idSerie = idSerie;
        this.tipo = tipo;
        this.exercicio = exercicio;
        this.data_inicio = data_inicio;
    ...
    public Series(int idSerie, String tipo, String exercicio, String data_inicio, String data_termino) {
        this.idSerie = idSerie;
        this.tipo = tipo;
        this.exercicio = exercicio;
        this.data_inicio = data_inicio;
